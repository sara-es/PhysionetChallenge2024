...
def extract_rows2(test_im, thresh = 50, plot_output = True):
    test_im = abs(test_im -1)*255 # invert colours
...
file = "C:/Users/hssdwo/Documents/GitHub/PhysionetChallenge2024/tiny_testset/faulty_traces/14083_hr-0.npy"
data = np.load(file)

#test_im = data[5]
#test_im = test_im[0:1550,:]
signals, rois = extract_rows2(data, thresh = 50, plot_output = True)
