...
def digitize_image_unet(restored_image, yolo_rois, sig_len=1000, max_duration=10, is_generated_image=True):
    ...
    restored_image, bounding_rect, yolo_rois_cropped = preprocess.crop_image(restored_image, box, yolo_rois)
    ...
    signal_coords, rois = extract_signals.extract_row_signals(restored_image, yolo_rois_cropped, n_lines=int(num_rows))
