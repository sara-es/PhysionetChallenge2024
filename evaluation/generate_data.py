...
def generate_training_data(data_folder, output_folder, verbose, max_samples):
    ...
    # img_gen_params.temperature = 0
    # img_gen_params.deterministic_temp = True
...
if __name__ == "__main__":
    ...
    output_folder_prefix = os.path.join("temp_data", "train") # will create images, masks, patches subfolders here
    verbose = True
    max_samples = None # set to None to train on all available
