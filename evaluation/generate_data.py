...
def generate_training_data(data_folder, output_folder, verbose, max_samples):
    ...
    if max_samples is not None:
        records_to_process = shuffle(records_to_process, random_state=42)[3000:3000+max_samples]
    ...
    # # generate patches
    Unet.patching.save_patches_batch(records_to_process, images_folder, masks_folder, constants.PATCH_SIZE, 
...
if __name__ == "__main__":
    ...
    verbose = True
    max_samples = 500 # set to None to train on all available
